package com.buritiscript.docker_manager.config;
...
// Para o Spring reconhecer que essa é uma classe de configuração
@Configuration
public class DockerClientConfig {
    ...
    // É um metodo que diz para o Spring retornar um Bean
    @Bean
